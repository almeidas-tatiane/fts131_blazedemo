...
class Helper_Func(object):
    __TIMEOUT = 10  # Definimos um limete de espera de 10 segundos

    # Definição de uma espera explicita
    def __init__(self, driver):  # Criou a defini;áo de inicialização da classe
    ...
    # Definição da abertura de uma URL / Acessr um site
    def open(self, url):
